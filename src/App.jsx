  ...
  return (
    <>
      <div
        ...
        style={{ ...style, marginBottom: 12, borderRadius: 16 }}
      >
        {children}
      </div>
      ...
      {showConfirm && (
        ...
        >
          ...
          >
            ...
            <h3 style={{ margin: "0 0 8px", fontSize: 18, color: DARK_PURPLE, fontFamily: FONT }}>削除しますか？</h3>
            <p style={{ margin: "0 0 20px", fontSize: 13, color: "#64748b", fontFamily: FONT }}>この操作は取り消せません</p>
        ...
        {tab === "schedule" && (
          <div>
            ...
            {viewMode === "list" && (
              ...
              return (
                <LongPressCard key={comp.id} onDelete={() => delComp(comp.id)} style={{ background: "linear-gradient(145deg, #ffffff 0%, #faf9ff 100%)", borderRadius: 16, padding: 16, boxShadow: "0 4px 20px rgba(30,27,75,0.08)", border: "1px solid #e9e5ff", animation: "slideUp 0.3s ease " + (i * 0.04) + "s both" }}>
            ...
            {data.history.length === 0 ? (
              ...
              <>
                ...
                {data.history.map((entry, i) => {
                  ...
                  return (
                    <LongPressCard key={entry.id} onDelete={() => delHist(entry.id)} style={{ background: "linear-gradient(145deg, #ffffff 0%, #faf9ff 100%)", borderRadius: 13, padding: 14, boxShadow: "0 4px 20px rgba(30,27,75,0.08)", border: "1px solid #e9e5ff", animation: "slideUp 0.3s ease " + (i * 0.04) + "s both" }}>
                      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                        <div>
